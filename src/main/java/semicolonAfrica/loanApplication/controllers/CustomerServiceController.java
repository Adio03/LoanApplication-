...
@PostMapping("/register")
    ...
    @GetMapping("/{customerId}/{loanId}")
    public ResponseEntity<?> checkLoanStatus(@PathVariable Long customerId,@PathVariable Long loanId){
    try{
        LoanApplicationStatus response = customerService.viewLoanStatus(customerId,loanId);
